...
SRCS		=	ft_atoi.c ft_bzero.c ft_findwordc.c ft_intlen.c ft_isalnum.c		\
				ft_isalpha.c ft_isascii.c ft_isblank.c ft_iscntrl.c ft_isdigit.c	\
				ft_isprint.c ft_ispunct.c ft_isspace.c ft_isupper.c ft_isxdigit.c	\
				ft_itoa.c ft_list_last.c ft_list_size.c ft_lstadd.c ft_lstdel.c		\
				ft_lstdelone.c ft_lstiter.c ft_lstmap.c ft_lstnew.c ft_memalloc.c	\
				ft_memccpy.c ft_memchr.c ft_memcmp.c ft_memcpy.c ft_memdel.c		\
				ft_memmove.c ft_memset.c ft_printlist.c ft_putchar.c				\
				...
				ft_toupper.c ft_wordlen.c

OBJS		=	ft_atoi.o ft_bzero.o ft_findwordc.o ft_intlen.o ft_isalnum.o		\
				ft_isalpha.o ft_isascii.o ft_isblank.o ft_iscntrl.o ft_isdigit.o	\
				ft_isprint.o ft_ispunct.o ft_isspace.o ft_isupper.o ft_isxdigit.o	\
				ft_itoa.o ft_list_last.o ft_list_size.o ft_lstadd.o ft_lstdel.o		\
				...
				ft_memmove.o ft_memset.o ft_printlist.o ft_putchar.o				\
